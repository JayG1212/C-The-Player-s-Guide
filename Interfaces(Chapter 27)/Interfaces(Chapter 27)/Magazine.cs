...
namespace Interfaces_Chapter_27_
{
    internal class Magazine :ILibraryItem
    {
        ...
        public Magazine(string aTitle, string anAuthor, int aPublicationYear, int anIssueNumber)
        {
            this.Title = aTitle;
            this.Author = anAuthor;
            this.PublicationYear = aPublicationYear;
            this.IssueNumber = anIssueNumber;
        }

        public Magazine(): this("n/a", "n/a", -1, -1)
        {
            // empty constructor
        }
